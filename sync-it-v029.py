"""
Sync two folders from systray V0.29 April 2020
Windows only.
------------------------
...
if os.path.exists('syncit.txt'):
    os.remove('syncit.txt')
    
logging.basicConfig(filename="syncit.txt",
                    filemode='x',
                    level=logging.DEBUG)
...
def msg_box(stray):
    ...
    Glo.custom_mbox.title('Sync It V0.29. ')
