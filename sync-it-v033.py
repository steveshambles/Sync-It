"""
Sync two folders from systray V0.33 April 2020
Windows only.
------------------------
...
def msg_box(stray):
    ...
    Glo.custom_mbox.title('Sync It V0.33. ')
...
def sync_help(stray):
    ...
    messagebox.showinfo('Sync It Help',
                        ...
                        'You choose to set PURGE files to ON or OFF in the\n'
